 ...
 * Description: Connects WordPress to selected Tornevall Networks Tools services, including Guestbook, Dynamic DNS and Statuspage.
 * Version: 0.3.0
...
require_once TTFW_PATH . 'includes/class-ttfw-guestbook-connection-admin.php';
require_once TTFW_PATH . 'includes/class-ttfw-statuspage-settings.php';
require_once TTFW_PATH . 'includes/class-ttfw-statuspage-api.php';
require_once TTFW_PATH . 'includes/class-ttfw-statuspage.php';
require_once TTFW_PATH . 'includes/class-ttfw-statuspage-admin.php';
